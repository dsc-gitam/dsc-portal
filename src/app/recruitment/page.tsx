...
export default function RecruitmentPage() {
  ...
  // Show closed message if recruitment deadline has passed
          ...
          <div className="bg-gradient-to-br from-red-50 to-orange-50 border-2 border-red-200 rounded-2xl shadow-xl p-8 mb-8">
            <div className="text-center">
              ...
              <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 font-display">
                Core Team Recruitment <span className="text-red-600">Closed</span>
              </h1>
              <p className="text-lg text-gray-700 mb-6 max-w-2xl mx-auto">
                Thank you for your interest in joining the GDGoC GITAM Core Team. 
                The recruitment period for this cycle closed on <span className="font-semibold">October 12th, 2025 at 5:00 PM</span>.
              </p>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6 text-left">
                ...
                <p className="text-gray-700 mb-4">
                  While core team applications are closed for this cycle, there are still many ways to be part of our community:
                </p>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <span>Join our GDG on Campus community and participate in events</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <span>Follow us on social media for updates on future recruitment cycles</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-green-500 mr-3 mt-1">✓</span>
                    <span>Attend our workshops and networking events</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="space-y-4">
                <a
                  href="https://gdg.community.dev/gdg-on-campus-gandhi-institute-of-technology-and-management-visakhapatnam-india-1"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-block bg-gradient-to-r from-blue-600 to-blue-500 text-white px-8 py-4 rounded-xl text-lg font-bold hover:shadow-xl transition-all duration-300 transform hover:scale-105 w-full md:w-auto"
                >
                  Join Our Community
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-xl p-8 mb-8">
          <div className="text-center mb-8">
            ...
            {/* Countdown Timer */}
            {timeLeft && (
              <div className="mt-6 bg-gradient-to-r from-red-50 to-orange-50 border-2 border-red-300 rounded-xl p-6">
                <p className="text-sm font-semibold text-red-900 mb-3">⏰ Recruitment Closes Soon!</p>
                <div className="flex justify-center gap-3 md:gap-6">
                  <div className="text-center">
                    <div className="bg-white rounded-lg px-3 py-2 md:px-4 md:py-3 shadow-md border border-red-200">
                  ...
                  <div className="text-center">
                    <div className="bg-white rounded-lg px-3 py-2 md:px-4 md:py-3 shadow-md border border-orange-200">
                  ...
                  <div className="text-center">
                    <div className="bg-white rounded-lg px-3 py-2 md:px-4 md:py-3 shadow-md border border-yellow-200">
                      <div className="text-2xl md:text-3xl font-bold text-yellow-600">{timeLeft.minutes}</div>
                      <div className="text-xs md:text-sm text-gray-600 font-medium">Minutes</div>
                    </div>
                  </div>
                  <div className="text-center">
                    <div className="bg-white rounded-lg px-3 py-2 md:px-4 md:py-3 shadow-md border border-green-200">
                      <div className="text-2xl md:text-3xl font-bold text-green-600">{timeLeft.seconds}</div>
                      <div className="text-xs md:text-sm text-gray-600 font-medium">Seconds</div>
                    </div>
                  </div>
                </div>
                <p className="text-sm text-gray-700 mt-4">
                  Applications close on <span className="font-bold">Sunday, October 12, 2025 at 5:00 PM</span>
                </p>
              </div>
            )}
          </div>
